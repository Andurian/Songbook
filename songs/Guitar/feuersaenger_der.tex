\beginsong{Der Feuersänger}[
  by={Sören Vogelsang},
  sr={\url{https://www.youtube.com/watch?v=747FUKEoTRA}}
]

\transposeChords{1}
\begin{infotext}
This key is for personal comfort. Original is in \textbf{Cm} (Capo 3).
\end{infotext}
...
\begin{otherlanguage}{ngerman}
  ...
  %\textnote{Chorus Instrumentalbegleitung}
  ...
  \textnote{Chorus one Octave higher}
  %\textnote{Gefolgt von Chorus Instrumentalbegleitung}
  ...
  \begin{performanceinstruction}
    From now on every chorus one octave higher
